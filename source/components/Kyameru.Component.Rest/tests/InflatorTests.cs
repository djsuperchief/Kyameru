...
public class InflatorTests
{
    ...
    public void CreateToCreatesChain()
    {
        ...
        inflator.RegisterTo(serviceCollection, Guid.NewGuid());
    ...
    public void MethodIsValid(string method, bool isValid = true)
    {
        ...
        {
            Assert.Throws<Core.Exceptions.ComponentException>(() => inflator.CreateToComponent(headers, serviceProvider, Guid.NewGuid()));
        }
    }
